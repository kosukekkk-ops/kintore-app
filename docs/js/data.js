...
const Data = (() => {
  ...
  const I18N = {
    ...
    en: {
      ...
      rest_hint: 'Start the interval (rest) timer with the play button (showing the time) at the bottom of the workout screen. Turn on "Auto-start on set done" to also start it with ✓. "+30s" extends; pause and "✕" remove from the timer itself. "▾" shrinks the large view; tap the bar to enlarge it again.',
