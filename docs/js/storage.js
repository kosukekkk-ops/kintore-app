...
const Store = (() => {
  ...
  const DEFAULT_SETTINGS = { unit: 'kg', lang: 'ja', restDefault: 180, restAuto: false, goalVolume: 5000, goalSleep: 7.5, goalProtein: 120, goalCalories: 2000, timerStyle: 'large' };
